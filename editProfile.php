    ...
    <main>
        <div class="wrapper">
            <div class="bcca-breadcrumb">
                <div class="bcca-breadcrumb-item"><i class="fa-solid fa-user-pen  fa-lg"></i> Edit Profile</div>
                <a href="index.php">
                    <div class="bcca-breadcrumb-item">Home</div>
                </a>
            </div>
            <section class="editProfile">
                <div id="editProfileCard" class="profile-card">
                    <div class="data">
                        <div class="image">
                            <img src=<?php echo '"images/' . $img . '"' ?> alt="" class="profile-pic" style="">
                        </div>
                        <h2>Edit Profile - <?php echo $f_name . ' ' . $l_name ?></h2>
                        <?php if (isset($_GET["changed"])) {
                            echo '<h4>Profile Updated Successfully</h4>';
                        }
                        ?>
                        <form action="updateForm.php" method="POST" class="form" id="form">
                            <div class="step-forms step-forms-active">
                                <div class="group-inputs">
                                    <label for="safeCountry">User Name </label>
                                    <input type="text" name="username" id="username" value="<?php echo $userName ?>" />
                                </div>
                                <div class="group-inputs">
                                    <label for="safeAddress">Password </label>
                                    <input type="text" name="Password" id="Password" value="<?php echo $pass ?>" />
                                </div>
                                <div class="group-inputs">
                                    <label for="safeDesc">First Name </label>
                                    <input type="text" name="FirstName" id="FirstName" value="<?php echo $f_name  ?>" />
                                </div>
                                <div class="group-inputs">
                                    <label for="safeDesc">Last Name </label>
                                    <input type="text" name="LastName" id="LastName" value="<?php echo $l_name  ?>" />
                                </div>
                            </div>
                            <div class="buttons">
